...
class Option(Config):
    ...
    #tariq
    root_dir = '/content/gdrive/My Drive/Colab/combined/' 

    # root dir of testing set
    #test_dir = '/home/liming/Documents/dataset/dataScienceBowl2018/testing_data'
    #tariq
    test_dir = '/content/gdrive/My Drive/Colab/testing_data/' 
    ...
    #tariq
    results_dir = '/content/gdrive/My Drive/Colab/results/' 
...
if __name__ == '__main__':
    ...
    """
    #tariq
    stage1_train_src = '/content/gdrive/My Drive/Colab/data-science-bowl-2018/stage1_train'
    stage1_train_dest = '/content/gdrive/My Drive/Colab/combined'
    stage1_test_src = '/content/gdrive/My Drive/Colab/data-science-bowl-2018/stage1_test'
    stage1_test_dest = '/content/gdrive/My Drive/Colab/testing_data'
